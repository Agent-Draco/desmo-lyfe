        ...
        <GlassCard className="p-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              scale: 0.98
            }} className="gap-2 py-3 px-4 rounded-xl border border-border bg-background hover:bg-muted transition-colors disabled:opacity-50 flex items-center justify-center">
